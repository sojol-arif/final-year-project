...
{  ?>
        <div class="product-listing-m gray-bg wow fadeInUp">
          ...
          <div class="product-listing-content">
            <h5 style="float:left;margin-bottom:50px"><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a></h5>
            <p class="list-price" style="margin-top:9px; float:right; margin-right:13px"><span class="price-rent">৳<?php echo htmlentities($result->PricePerDay);?></span>  /Day</p>
            <ul style="clear:left">
